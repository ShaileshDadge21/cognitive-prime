        ...
        <GlassCard className="col-span-12 lg:col-span-7">
          <SectionHeader
            ...
            action={
              <button className="text-xs text-muted-foreground hover:text-foreground flex items-center gap-1">
                All decks <ArrowUpRight className="h-3 w-3" />
              </button>
            }
          />
          <div className="space-y-2">
            {queue.map((q, i) => (
              <div
                key={i}
                className="flex items-center gap-3 p-3 rounded-xl bg-surface/50 border border-white/5 hover:border-white/15 transition"
              >
                <div
        ...
        <GlassCard className="col-span-12 lg:col-span-5">
          ...
          <div className="space-y-3">
            {recommendations.map((r, i) => (
              <div
                key={i}
                className="p-4 rounded-2xl bg-surface/40 border border-white/5 hover:border-white/15 transition group cursor-pointer"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 inline-block text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/5">
                      {r.tag}
                    </div>
                  </div>
